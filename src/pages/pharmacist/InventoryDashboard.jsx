    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-content">
        <h1 style={{ fontSize: '28px', fontWeight: '700', color: 'var(--text-h)', margin: '0 0 8px 0' }}>
          Inventory Dashboard (Pharmacist)
        </h1>
        <p style={{ color: 'var(--text)', fontSize: '15px', margin: 0 }}>
          Summary of stock levels, low-stock notifications, and near expiry warnings for your pharmacy {user?.phc_id && `(${user.phc_id.toUpperCase()})`}.
        </p>
        ...
        <div className="card-placeholder">
          ...
          <p style={{ color: 'var(--text)', fontSize: '14px', margin: 0 }}>
            Medicine inventory tables, stock updates, transfer order management (request/confirm/dispatch), and auditing history logs will be active here in subsequent build phases.
          </p>
        </div>
      </main>
    </div>
