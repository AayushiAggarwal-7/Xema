...
const styles = {
  ...
  page: { display: 'grid', gridTemplateColumns: '1fr 260px', gap: '24px', padding: '20px 24px 24px' },
  ...
  sidebar: { backgroundColor: '#F3E9D2', borderRadius: '18px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '10px', height: 'fit-content' },
